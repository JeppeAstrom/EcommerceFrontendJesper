...
const CartModal:NextPage<Props> = ({handleToggleCart}) => {
    return(<div className="fixed top-0 right-0 w-96 h-full border">
        <div className="justify-between flex p-4 border">
        <div>Varukorg</div>
        <button onClick={handleToggleCart} className=""><svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
