...
const PdpContainer: NextPage<Props> = ({
  fetchedProduct,
  productGroup,
  recommendedProducts,
  reviews,
    ...
    <>
      <div className="mx-auto px-4 mb-10 mt-8 lg:mt-0">
              ...
              <div className="pt-4">
                {fetchedProduct.sizes.length > 0 && (
                  <div ref={wrapperRef} className="relative">
                    ...
                    {isOpen && (
                      <ul className="absolute border-l border-r w-full bg-white z-[12] cursor-pointer">
                ...
                <div className="lg:pt-4 pt-0 gap-2 justify-center items-center hidden lg:flex">
                  ...
                  <button
                    ...
                    className="border border-black min-h-12 min-w-12 bg-white items-center flex justify-center"
                  >
                    <HeartIcon favourite={favourite} className="h-9 w-9" />
                  </button>
                </div>
              </div>
            </div>
        ...
        {visibleReviews && visibleReviews.length > 0 && (
          <div
            ref={reviewRef}
            className="flex flex-col gap-6 w-full md:w-[500px] px-4 mb-10 pt-4"
          >
            <span className="text-2xl border-b border-black pb-2 w-fit font-semibold">
              Recensioner
            </span>
