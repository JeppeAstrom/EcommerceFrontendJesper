...
const BuyIcon:NextPage<Props> = ({className, onClick, product}) => {
    ...
    return (
       ...
       <svg onClick={() => {
        ...
        }} className={className} xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
...
<path d="M13 13V11M13 11V9M13 11H15M13 11H11" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
