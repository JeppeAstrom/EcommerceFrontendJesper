...
const CartIcon:NextPage<Props> = ({className, openCart}) => {
    return (
        <>
        <svg onClick={openCart} className={className} xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
