...
const CartIcon:NextPage<Props> = ({className, openCart, cartCount}) => {
    ...
    return (
        ...
        <svg className={className} onClick={openCart} xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"> 
